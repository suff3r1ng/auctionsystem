				...
				<div class="card-body container-fluid">
					<div class="row d-flex justify-content-center">
						<div class="col-md-5">
							...
							<input type="file" class="form-control " id="img" name="img" onchange="displayImg2(this,$(this))">
						</div>
						...
						<div class="col-md-5">
							...
							<div class="container justify-conten-center">
								<img src="<?php echo isset($img_fname) ? 'admin/uploads/' . $img_fname : '' ?>" alt="" id="img_path-field">
							</div>
						</div>
					</div>
					...
					<div class="row d-flex justify-content-center">
						...
						<div class="col-md-4 h-25 m-3  ">
							<div class="col m-2 justify-content-md-center">
								<button class="form-control btn btn-md-5 btn-secondary m-4 create">Create Category</button>
							</div>
						</div>
		...
		window.onload = function() {
			...
			$('.create').click(function(){
				...
				$('#manage-category').submit(function(e) {
					e.preventDefault()
					$.ajax({
						url: 'admin/functions/ajax.php?action=save_category',
			...
			$('#manage-product').submit(function(e) {
				...
				$('#msg').html('')
				$.ajax({
					url: 'admin/functions/ajax.php?action=save_product_user',
					data: new FormData($(this)[0]),
					cache: false,
					contentType: false,
					processData: false,
